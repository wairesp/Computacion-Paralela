...
void Allocate_arrays(
    ...
    *local_A_pp = static_cast<double*>(malloc(local_m*n*sizeof(double)));
    *local_x_pp = static_cast<double*>(malloc(local_n*sizeof(double)));
    *local_y_pp = static_cast<double*>(malloc(local_m*sizeof(double)));
...
void Read_vector(
    ...
    if (my_rank == 0) {
        vec = static_cast<double*>(malloc(n*sizeof(double)));
 ...
 */
void Mat_vect_mult(
        double    local_A[]  /* in  */,//rows of a
        double    local_x[]  /* in  */,
        double    local_y[]  /* out */,
        int       local_m    /* in  */,//number of rows
        int       n          /* in  */,
        int       local_n    /* in  */,
        MPI_Comm  comm       /* in  */) {
    double* x;
